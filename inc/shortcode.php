...
?>
  ...
  <form class="main-form" id="main-form-post-data" action="" method="POST">
    ...
    <input id="submit-button" class="btn-button" type="submit" name="send" value="<?php esc_html_e('Submit', 'youtube-thumbnail-downloader'); ?>">
  </form>
  <!-- start download box -->
  <div class="big-box" style="display: none;">
    <div class="contents">
      <img width="270" height="200" id="image-url" src="" alt="">
      <a class="btn-button" id="download-url" href="<?php echo plugins_url("inc/download/download.php", dirname(__FILE__)) ?>?youtubedowwnload=image&url=">Download
        MQ 320x180</a>
    </div>
    <div class="contents">
      <img width="270" height="200" id="image-url" src="" alt="">
